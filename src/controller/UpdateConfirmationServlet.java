...
@WebServlet(urlPatterns = { "/update-confirm" })
public class UpdateConfirmationServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("updateconfirmation.jsp").forward(request, response);
	}
